...
set guifont=Droid\ Sans\ Mono\ 12                 "设置字体:字号（字体名称空格用下划线代替）
set nowrap                                            "设置不自动换行
...
"" Racer : Rust code complete 
set hidden
let g:racer_cmd= "/home/wayslog/bin/racer"
let g:racer_cmd = "/home/wayslog/tools/racer/target/release/racer"
let $RUST_SRC_PATH="/home/wayslog/tools/rust/src/"
